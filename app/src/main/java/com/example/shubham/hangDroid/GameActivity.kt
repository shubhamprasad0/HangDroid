...
class GameActivity : AppCompatActivity() {
    ...
    private fun clearGameStatus() {
        ...
        // set new word for the next game
        setRandomWord()
    }
    ...
    /**
     * Sets the word for the game randomly
     */
    private fun setRandomWord() {
        val randomGenerator = SecureRandom()
        val index = randomGenerator.nextInt(wordArray.size)
